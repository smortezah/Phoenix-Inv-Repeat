...
//    build hash table
//************************************************************/
//hashTable_t Hash::hashTableBuild (std::ifstream targetFile, bool isInvertedRepeat)
//{
//
//    // context, that slides in the dataset
//    std::string context(CONTEXT_DEPTH, 'A');
...
/***********************************************************
    update hash table
************************************************************/
hashTable_t Hash::hashTableBuildUpdate (std::ifstream targetFile,
                                   bool isInvertedRepeat,
                                   bool isFirstTime)
{
//    hashTable_t hTable;
            ...
            switch (strDataset[ i ])
            {
                case 'A':
                    ...
                    if (isInvertedRepeat)
                    {
                        ...
                        {
                            case 'A':
                                ++(hTable[ invRepeatContext ])[ 0 ];
                                break;
                            case 'C':
                                ++(hTable[ invRepeatContext ])[ 1 ];
                                break;
                            case 'T':
                                ++(hTable[ invRepeatContext ])[ 2 ];
                                break;
                            case 'G':
                                ++(hTable[ invRepeatContext ])[ 3 ];
                                break;
                            case 'N':
                                ++(hTable[ invRepeatContext ])[ 4 ];
                                break;
                            default:
                                break;
                        }
