...
REF_DATASET="";  for i in Y; do REF_DATASET+=$REF_SPECIES${i}" "; done
...
TAR_DATASET="";  for i in Y; do TAR_DATASET+=$TAR_SPECIES${i}" "; done
...
ALPHA_DENS="400"        # list of alpha denominators
CTX=20
