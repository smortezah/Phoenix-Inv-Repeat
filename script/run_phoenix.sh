...
#     for((ctx=$MIN_CTX; ctx<=$MAX_CTX; ctx+=1)); do
     ./phoenix -m $ir,$ctx,$alphaDen -t dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/HS21,dataset/PT21,dataset/HS21,dataset/HS21,dataset/PT21,dataset/HS21,dataset/HS21,dataset/HS21 -r $FLD_dataset/$refDataset \
