...
YTICS="`awk 'BEGIN{getline}{printf "%s ",$1}' \
    "$FLD_dat/diff_filtered-$REF-$TAR.$INF_FTYPE"`"
XTICS="`head -1 "$FLD_dat/diff_filtered-$REF-$TAR.$INF_FTYPE" \
...
set xtics( \
"Pseudogymnoascus destructans strain 20631-21 mitochondrion", 0 \
...
"Pyronema omphalodes strain CBS 100304 culture-collection CBS:100304 \
mitochondrion", 4 \
"Colletotrichum lupini strain CBS 119142 culture-collection CBS:119142 \
mitochondrion", 5 \
...
"Gigaspora rosea mitochondrion", 25 \
"Marssonina brunnea f. sp. 'multigermtubi' mitochondrion", 26 \
"Verticillium dahliae mitochondrion", 27 \
"Metarhizium anisopliae mitochondrion", 28 \
